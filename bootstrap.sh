...
#   - PROJECT_ID set (env var or edited in this file)
...
STATE_BUCKET="${PROJECT_ID}-jamtheory-terraform-state"
...
log "Next steps:"
log "  1. Copy infra/terraform.tfvars.example → infra/terraform.tfvars"
log "     and fill in project_id + youtube_api_key."
